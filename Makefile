...
main.snd: FORCE
	...
	sed -i s/.*AIIC.*// main.adx #remove titles which biblatex puts into the name index
	sed -i s/.*Akademie.*// main.adx #remove titles which biblatex puts into the name index
	sed -i s/.*PACTE.*// main.adx #remove titles which biblatex puts into the name index
	sed -i s/.*Core.*// main.adx #remove titles which biblatex puts into the name index
	sed -i s/.*PACTE.*// main.adx #remove titles which biblatex puts into the name index
